...
// type KeysToOmit = "captionLayout" | "mode"; // Remove "showWeekNumber"

// type KeysToOmitSingle = "captionLayout" | "mode";
// type KeysToOmitRange = "mode"; // only omit what's safe here

// type SingleProps = Omit<DayPickerSingleProps, KeysToOmitSingle>;
// type RangeProps = Omit<DayPickerRangeProps, KeysToOmitRange>;
